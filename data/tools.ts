...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    does:
      "Writes `vendor: true`, installs the entrypoint, leaves `vendor/` plus `deno.lock` in the app folder. Copy that folder and run with `deno run --cached-only`. This is not Deno's `pack` command (npm tarballs).",
    example: [
      {
